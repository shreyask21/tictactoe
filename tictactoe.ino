...
int checkwin()
{
  if (game.moves != 0)
  {
    if (game.table[0] == 1 && game.table[1] == 1 && game.table[2] == 1)
    {
      for (int i = 0; i < 4; i++)
      {
    ...
    if (game.table[3] == 1 && game.table[4] == 1 && game.table[5] == 1)
    {
      for (int i = 0; i < 4; i++)
      {
    ...
    if (game.table[6] == 1 && game.table[7] == 1 && game.table[8] == 1)
    {
      for (int i = 0; i < 4; i++)
      {
    ...
    if (game.table[0] == 1 && game.table[3] == 1 && game.table[6] == 1)
    {
      for (int i = 0; i < 4; i++)
      {
    ...
    if (game.table[1] == 1 && game.table[4] == 1 && game.table[7] == 1)
    {
      for (int i = 0; i < 4; i++)
      {
    ...
    if (game.table[2] == 1 && game.table[5] == 1 && game.table[8] == 1)
    {
      for (int i = 0; i < 4; i++)
      {
    ...
    if (game.table[0] == 1 && game.table[4] == 1 && game.table[8] == 1)
    {
      return 1;
    }
    if (game.table[2] == 1 && game.table[4] == 1 && game.table[6] == 1)
    {
      return 1;
    }

    if (game.table[0] == 2 && game.table[1] == 2 && game.table[2] == 2)
    {
      for (int i = 0; i < 4; i++)
      {
        tft.drawLine(40, 39 + i, 280, 39 + i, MAGENTA);
    ...
    if (game.table[3] == 2 && game.table[4] == 2 && game.table[5] == 2)
    {
      for (int i = 0; i < 4; i++)
      {
        tft.drawLine(40, 119 + i, 280, 119 + i, MAGENTA);
    ...
    if (game.table[6] == 2 && game.table[7] == 2 && game.table[8] == 2)
    {
      for (int i = 0; i < 4; i++)
      {
        tft.drawLine(40, 199 + i, 280, 199 + i, MAGENTA);
    ...
    if (game.table[0] == 2 && game.table[3] == 2 && game.table[6] == 2)
    {
      for (int i = 0; i < 4; i++)
      {
        tft.drawLine(79 + i, 0, 79 + i, 240, MAGENTA);
    ...
    if (game.table[1] == 2 && game.table[4] == 2 && game.table[7] == 2)
    {
      for (int i = 0; i < 4; i++)
      {
        tft.drawLine(159 + i, 0, 159 + i, 240, MAGENTA);
    ...
    if (game.table[2] == 2 && game.table[5] == 2 && game.table[8] == 2)
    {
      for (int i = 0; i < 4; i++)
      {
        tft.drawLine(279 + i, 0, 279 + i, 240, MAGENTA);
    ...
    if (game.table[0] == 2 && game.table[4] == 2 && game.table[8] == 2)
    {
      return 2;
    }
    if (game.table[2] == 2 && game.table[4] == 2 && game.table[6] == 2)
    {
      return 2;
    }
